...
server = {
    ...
    'host': os.environ.get('PADDLES_SERVER_HOST', '172.23.230.157')
}
...
# )
address = 'http://m1306008.lnxero1.boe'
job_log_href_templ = 'http://172.23.232.8/{run_name}/{job_id}/teuthology.log'  # noqa
